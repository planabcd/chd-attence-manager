...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript">
        $(function(){
            //点击提交按钮
            $("#submitBtn").click(editAppVersion);
        ...
        function editAppVersion(){
            ...
            //取消提交按钮的绑定事件,防止重复提交
            $("#submitBtn").unbind('click', editAppVersion);
            var editUrl = "${pageContext.request.contextPath}/appversion/edit";

            $("#edit_appversion_form").ajaxSubmit({
                type: "POST",
                url : editUrl,
                dataType:"json",
...
<body>
<div class="easyui-panel" data-option="fit:true" title="编辑APP版本" style="padding:10px" >
<div class="container" style="margin:10px">
    <div class="row">
        <div class="col-md-10 col-sm-10 col-xs-10 ">
            <form id="edit_appversion_form" method="post" class="form-horizontal" role="form">

                <div class="form-group">
                    <label for="versionCode" class="col-sm-2 col-md-2 control-label">版本号</label>
                    <div class="col-sm-10">
                        <input value="${appVersion.versionCode}" type="text" name="versionCode" id="versionCode" class="form-control"  placeholder="格式为:x.x.x,x为数字,必填">
                    </div>
                </div>
                <div class="form-group">
                    <label for="forceUpdateCode" class="col-sm-2 col-md-2 control-label" >强制升级</label>
                    <div class="col-sm-10">
                        <input value="${appVersion.forceUpdateCode}" type="text" name="forceUpdateCode" id="forceUpdateCode" class="form-control"  placeholder="格式为:x.x.x,x为数字">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input  value="${appVersion.title}" type="text" name="title" id="title" class="form-control"  >
                    </div>
                </div>
                <div class="form-group">
                    <label for="content" class="col-sm-2 col-md-2 control-label">更新内容</label>
                    <div class="col-sm-10">
                        <textarea name="content" id="content" class="form-control" style="resize: none;height: 200px">${appVersion.content}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="url" class="col-sm-2 col-md-2 control-label">下载地址</label>
                    <div class="col-sm-10">
                        <input value="${appVersion.url}" type="text" name="url" id="url" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 col-md-2 control-label">客户端</label>
                    <label class="checkbox-inline">
                        <input type="radio" name="platform" value="ANDROID" ${appVersion.platform=="ANDROID"?"checked='checked'":""}>ANDROID
                    </label>
                    <label class="checkbox-inline">
                        <input type="radio" name="platform" value="IOS" ${appVersion.platform=="IOS"?"checked='checked'":""}>IOS
                    </label>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="checkbox-inline">
                        <input type="radio" name="latestVersion" value="1" checked="true" ${appVersion.latestVersion==1?"checked='checked'":""}>是
                    </label>
                    <label class="checkbox-inline">
                        <input type="radio" name="latestVersion" value="0" ${appVersion.latestVersion!=1?"checked='checked'":""}>否
                    </label>
                </div>
                <input type="hidden" value="${appVersion.id}" name="id" class="btn" >
